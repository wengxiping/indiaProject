<template>
  <view class="page-content">
	  <u-navbar back-text="提现记录" title="" :is-fixed="true" :background="background" :back-text-style='backStyle' back-icon-color='#000'>
	  </u-navbar>
...
<script>
	export default {
		...
		methods:{
			getMyczlistFunc(){
				uni.$u.api.getMyczlist({type:2,page:this.page}).then(ret=>{
					if(ret && ret.code == 1)
					{
